...
use crate::py_utils;
use crate::suite::{RISTRETTO255_SHA512, SuiteId};
use crate::suite::ML_KEM_768_RISTRETTO255_SHA512;
use crate::suite::P256_SHA256;
use crate::suite::P384_SHA384;
use crate::suite::P521_SHA512;
...
pub fn register(py: Python<'_>, parent: &Bound<'_, PyModule>) -> PyResult<()> {
    ...
    module.add("ML_KEM_768_RISTRETTO255_SHA512", ML_KEM_768_RISTRETTO255_SHA512)?;
